...
public class Numero36 {
	...
	public static void main(String[] args) {
		...
		System.out.println("2 - Simone Tebet;");
		System.out.println("3 - Luiz Felipe d’Avila;");
		System.out.println("4 - Bozonaro;");
		...
		System.out.println("Lula = " + candidato1);
		System.out.println("Simone Tebet = " + candidato2);
		System.out.println("Luiz Felipe d’Avila = " + candidato3);
		System.out.println("Bozo = " + candidato4);
